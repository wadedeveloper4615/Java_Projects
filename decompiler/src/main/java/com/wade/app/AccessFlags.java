...
public enum AccessFlags {
    ...
    AccessFlags(int flag, String name) {
        this.flag = flag;
        this.name = name;
    }
    ...
    public final boolean isSet(AccessFlags p) {
    ...
    public AccessFlags setFlag(int flag) {
        this.flag = flag;
        return this;
    }

    public static AccessFlags read(DataInputStream dataInputStream) throws IOException {
        int flag = dataInputStream.readUnsignedShort();
        AccessFlags f = AccessFlags.ACC_DUMMY;
        f.setFlag(flag);
        return f;
    }
}
