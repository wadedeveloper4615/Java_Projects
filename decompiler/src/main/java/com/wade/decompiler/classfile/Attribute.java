...
public abstract class Attribute implements Cloneable, Node {
    ...
    /**
     * Add an Attribute reader capable of parsing (user-defined) attributes named
     * "name". You should not add readers for the standard attributes such as
     * "LineNumberTable", because those are handled internally.
     *
     * @param name the name of the attribute as stored in the class file
     * @param r    the reader object
     * @deprecated (6.0) Use
     *             {@link #addAttributeReader(String, UnknownAttributeReader)}
     *             instead
     */
    @java.lang.Deprecated
    ...
    /**
     * Class method reads one attribute from the input data stream. This method must
     * not be accessible from the outside. It is called by the Field and Method
     * constructor methods.
     *
     * @see Field
     * @see Method
