 ...
 * JavaClass</A> object on success. When an I/O error or an inconsistency occurs
 * an appropiate exception is propagated back to the caller.
 *
 * The structure and the names comply, except for a few conveniences, exactly
 * with the <A href="http://docs.oracle.com/javase/specs/"> JVM specification
...
public final class ClassParser {
    ...
    /**
     * Checks whether the header of the file is ok. Of course, this has to be the
