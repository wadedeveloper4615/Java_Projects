...
public abstract class Constant implements Cloneable, Node {
    ...
    /*
     * In fact this tag is redundant since we can distinguish different `Constant'
     * objects by their type, i.e., via `instanceof'. In some places we will use the
     * tag for switch()es anyway.
     *
     * First, we want match the specification as closely as possible. Second we need
     * the tag as an index to select the corresponding class name from the
    ...
    /**
     * Returns value as defined by given BCELComparator strategy. By default two
     * Constant objects are said to be equal when the result of toString() is equal.
     *
    ...
    /**
     * Returns value as defined by given BCELComparator strategy. By default return
     * the hashcode of the result of toString().
     *
