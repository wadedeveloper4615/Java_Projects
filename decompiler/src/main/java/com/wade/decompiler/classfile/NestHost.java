...
/**
 * This class is derived from <em>Attribute</em> and records the nest host of
 * the nest to which the current class or interface claims to belong. There may
 * be at most one NestHost attribute in a ClassFile structure.
 *
 * @see Attribute
 */
