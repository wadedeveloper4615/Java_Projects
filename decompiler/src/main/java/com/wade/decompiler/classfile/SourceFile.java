...
public final class SourceFile extends Attribute {
    ...
    /**
     * @param name_index      Index in constant pool to CONSTANT_Utf8, which should
     *                        represent the string "SourceFile".
     * @param length          Content length in bytes, the value should be 2.
     * @param constantPool    The constant pool that this attribute is associated
     *                        with.
     * @param sourceFileIndex Index in constant pool to CONSTANT_Utf8. This string
     *                        will be interpreted as the name of the file from which
     *                        this class was compiled. It will not be interpreted as
     *                        indicating the name of the directory contqining the
     *                        file or an absolute path; this information has to be
     *                        supplied the consumer of this attribute - in many
     *                        cases, the JVM.
     */
