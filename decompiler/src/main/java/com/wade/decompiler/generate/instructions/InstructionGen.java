...
public class InstructionGen {
    ...
    public static InstructionGen read(int offset, Instruction instr) {
        InstructionGen instrgen = switch (instr.getOpcode()) {
            ...
            case DADD -> new AddGen(offset, (DADD) instr);
            ...
            case DDIV -> new DivGen(offset, (DDIV) instr);
            ...
            case DMUL -> new MulGen(offset, (DMUL) instr);
            case DNEG -> new NegGen(offset, (DNEG) instr);
            case DREM -> new RemGen(offset, (DREM) instr);
            ...
            case DSUB -> new SubGen(offset, (DSUB) instr);
            ...
            case FADD -> new AddGen(offset, (FADD) instr);
            ...
            case FDIV -> new DivGen(offset, (FDIV) instr);
            ...
            case FMUL -> new MulGen(offset, (FMUL) instr);
            case FNEG -> new NegGen(offset, (FNEG) instr);
            case FREM -> new RemGen(offset, (FREM) instr);
            ...
            case FSUB -> new SubGen(offset, (FSUB) instr);
            ...
            case IADD -> new AddGen(offset, (IADD) instr);
            case IALOAD -> new ArrayLoadGen(offset, (IALOAD) instr);
            case IAND -> new AndGen(offset, (IAND) instr);
            ...
            case IDIV -> new DivGen(offset, (IDIV) instr);
            ...
            case IMUL -> new MulGen(offset, (IMUL) instr);
            case INEG -> new NegGen(offset, (INEG) instr);
            ...
            case IOR -> new OrGen(offset, (IOR) instr);
            case IREM -> new RemGen(offset, (IREM) instr);
            case IRETURN -> new ReturnGen(offset, (IRETURN) instr);
            case ISHL -> new ShiftGen(offset, (ISHL) instr);
            case ISHR -> new ShiftGen(offset, (ISHR) instr);
            ...
            case ISUB -> new SubGen(offset, (ISUB) instr);
            case IUSHR -> new ShiftGen(offset, (IUSHR) instr);
            case IXOR -> new XOrGen(offset, (IXOR) instr);
            ...
            case LADD -> new AddGen(offset, (LADD) instr);
            case LALOAD -> new ArrayLoadGen(offset, (LALOAD) instr);
            case LAND -> new AndGen(offset, (LAND) instr);
            ...
            case LDIV -> new DivGen(offset, (LDIV) instr);
            ...
            case LMUL -> new MulGen(offset, (LMUL) instr);
            case LNEG -> new NegGen(offset, (LNEG) instr);
            case LOOKUPSWITCH -> new LookupSwitchGen(offset, (LOOKUPSWITCH) instr);
            case LOR -> new OrGen(offset, (LOR) instr);
            case LREM -> new RemGen(offset, (LREM) instr);
            case LRETURN -> new ReturnGen(offset, (LRETURN) instr);
            case LSHL -> new ShiftGen(offset, (LSHL) instr);
            case LSHR -> new ShiftGen(offset, (LSHR) instr);
            ...
            case LSUB -> new SubGen(offset, (LSUB) instr);
            case LUSHR -> new ShiftGen(offset, (LUSHR) instr);
            case LXOR -> new XOrGen(offset, (LXOR) instr);
