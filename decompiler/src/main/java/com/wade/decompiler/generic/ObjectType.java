...
public class ObjectType extends ReferenceType {
     ...
     *
     * @throws ClassNotFoundException if the class referenced by this type can't be
     *                                found
     */
     ...
     * non-existant entity.
     *
     * @deprecated (since 6.0) this method returns an inaccurate result if the class
     *             or interface referenced cannot be found: use
     ...
     *         interface
     * @throws ClassNotFoundException if the class or interface referenced by this
     *                                type can't be found
     */
    ...
    /**
     * Return true if this type references an interface, false if it references a
     * class.
     *
     * @return true if the type references an interface, false if it references a
     *         class
     * @throws ClassNotFoundException if the class or interface referenced by this
     *                                type can't be found
     */
     ...
     *
     * @throws ClassNotFoundException if any of this class's superclasses can't be
     *                                found
     */
