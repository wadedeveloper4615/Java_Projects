...
//        String kind = (opcode < InstructionOpCodes.IASTORE.getOpcode()) ? "Load" : "Store";
...
//        short opcode = (short) i.getOpcode().getOpcode();
//        if ((InstructionOpCodes.read(opcode) != null) && !(i instanceof ConstantPushInstruction) && !(i instanceof ReturnInstruction)) { // Handled below
...
//        short opcode = (short) i.getOpcode().getOpcode();
//        Type type = i.getType(_cp);
//        if (opcode == InstructionOpCodes.IINC.getOpcode()) {
//            _out.println("il.append(new IINC(" + i.getIndex() + ", " + ((IINC) i).getIncrement() + "));");
//        } else {
//            String kind = (opcode < InstructionOpCodes.ISTORE.getOpcode()) ? "Load" : "Store";
