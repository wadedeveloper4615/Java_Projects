...
public abstract class Repository {
    ...
    public static JavaClass addClass(JavaClass clazz) {
        JavaClass old = repository.findClass(clazz.getClassName().getName());
     ...
     * @throws ClassNotFoundException if the named class can't be found, or if any
     *                                of its superclasses or superinterfaces can't
     *                                be found
     */
    ...
    /**
     * @return list of super classes of clazz in ascending order, i.e., Object is
     ...
     * @return list of super classes of clazz in ascending order, i.e., Object is
     *         always the last element.
     * @throws ClassNotFoundException if the named class or any of its superclasses
     *                                can't be found
     */
    ...
    public static JavaClass lookupClass(ClassFileName name) throws ClassNotFoundException {
        return repository.loadClass(name.getName());
    }
    ...
    /**
     * @return class file object for given Java class by looking on the system class
     *         path; returns null if the class file can't be found
     */
