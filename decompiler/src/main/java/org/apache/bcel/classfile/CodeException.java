...
public final class CodeException implements Cloneable, Node, Constants {
    ...
    private int catchType; /*
                            * If this is zero the handler catches any exception, otherwise it points to the
    ...
    /**
     * @param startPc   Range in the code the exception handler is active, startPc
     *                  is inclusive while
     * @param endPc     is exclusive
     * @param handlerPc Starting address of exception handler, i.e., an offset from
     *                  start of code.
     * @param catchType If zero the handler catches any exception, otherwise it
     *                  points to the exception class which is to be caught.
     */
    ...
    /**
     * @return 0, if the handler catches any exception, otherwise it points to the
     *         exception class which is to be caught.
     */
