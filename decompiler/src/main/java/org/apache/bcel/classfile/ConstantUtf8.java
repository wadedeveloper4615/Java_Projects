 ...
 * </p>
 * <ul>
 * <li>{@value #SYS_PROP_CACHE_MAX_ENTRIES} (since 6.4): The size of the cache,
 * by default 0, meaning caching is disabled.</li>
 * <li>{@value #SYS_PROP_CACHE_MAX_ENTRY_SIZE} (since 6.0): The maximum size of
 * the values to cache, by default 200, 0 disables caching. Values larger than
 * this are <em>not</em> cached.</li>
