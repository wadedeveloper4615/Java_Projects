...
public abstract class FieldOrMethod extends AccessFlags implements Cloneable, Node {
     ...
     * @deprecated (6.0) Use {@link #FieldOrMethod(java.io.DataInput, ConstantPool)}
     *             instead.
     */
    @java.lang.Deprecated
     ...
     * where the 'regular' signature may be (Ljava/util/Vector;)V the signature
     * attribute may in fact say 'Ljava/lang/Vector&lt;Ljava/lang/String&gt;;' Coded
     * for performance - searches for the attribute only when requested - only
