...
public final class Method extends FieldOrMethod {
    ...
    /**
     * @return ExceptionTable attribute of method, if any, i.e., list all exceptions
     *         the method may throw not exception handlers!
     */
     ...
     * main(String[] args) throws IOException', e.g.
     *
