...
public enum InstructionOpCodes {
  //@formatter:off
    ...
    InstructionOpCodes(int tag) {
        this.opcode = tag;
        this.name = Const.OPCODE_NAMES[tag];
        this.numberOfOperands = Const.NO_OF_OPERANDS[tag];
        this.consumeStack = Const.CONSUME_STACK[tag];
        this.produceStack = Const.PRODUCE_STACK[tag];
        this.typeOfOperands = Const.TYPE_OF_OPERANDS[tag];
    }
