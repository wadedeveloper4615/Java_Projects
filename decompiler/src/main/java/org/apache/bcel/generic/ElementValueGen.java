...
public abstract class ElementValueGen {
    /**
     * @deprecated (since 6.0) will be made private and final; do not access
     *             directly, use getter
     */
    @Deprecated
    protected int type;
    ...
    /**
     * Creates an (modifiable) ElementValueGen copy of an (immutable) ElementValue -
     * constant pool is assumed correct.
     */
