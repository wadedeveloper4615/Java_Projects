...
public abstract class ReferenceType extends Type {
     ...
     * ReferenceType referencing a class, not an interface). If one of the types is
     * a superclass of the other, the former is returned. If "this" is Type.NULL,
     * then t is returned. If t is Type.NULL, then "this" is returned. If "this"
     * equals t ['this.equals(t)'] "this" is returned. If "this" or t is an
     * ArrayType, then Type.OBJECT is returned. If "this" or t is a ReferenceType
     * referencing an interface, then Type.OBJECT is returned. If not all of the two
     * classes' superclasses cannot be found, "null" is returned. See the JVM
     * specification edition 2, "�4.9.2 The Bytecode Verifier".
     *
     * @deprecated use getFirstCommonSuperclass(ReferenceType t) which has slightly
     *             changed semantics.
     * @throws ClassNotFoundException on failure to find superclasses of this type,
     *                                or the type passed as a parameter
     */
    @Deprecated
    public ReferenceType firstCommonSuperclass(final ReferenceType t) throws ClassNotFoundException {
        ...
        if (this.equals(t)) {
            return this;
            /*
             * TODO: Above sounds a little arbitrary. On the other hand, there is no object
             * referenced by Type.NULL so we can also say all the objects referenced by
             * Type.NULL were derived from java.lang.Object. However, the Java Language's
             * "instanceof" operator proves us wrong: "null" is not referring to an instance
             * of java.lang.Object :)
             */
        }
     ...
     * then t is returned. If t is Type.NULL, then "this" is returned. If "this"
     * equals t ['this.equals(t)'] "this" is returned. If "this" or t is an
     * ArrayType, then Type.OBJECT is returned; unless their dimensions match. Then
     * an ArrayType of the same number of dimensions is returned, with its basic
     * type being the first common super class of the basic types of "this" and t.
     * If "this" or t is a ReferenceType referencing an interface, then Type.OBJECT
     * is returned. If not all of the two classes' superclasses cannot be found,
     * "null" is returned. See the JVM specification edition 2, "�4.9.2 The
     * Bytecode Verifier".
     *
     * @throws ClassNotFoundException on failure to find superclasses of this type,
     *                                or the type passed as a parameter
    ...
    /**
     * Return true iff this is assignment compatible with another type t as defined
     * in the JVM specification; see the AASTORE definition there.
     *
    ...
    /**
     * Return true iff this type is castable to another type t as defined in the JVM
     * specification. The case where this is Type.NULL is not defined (see the
     * CHECKCAST definition in the JVM specification). However, because e.g.
     * CHECKCAST doesn't throw a ClassCastException when casting a null reference to
     * any Object, true is returned in this case.
     *
     * @throws ClassNotFoundException if any classes or interfaces required to
     *                                determine assignment compatibility can't be
     *                                found
    ...
    public boolean isCastableTo(final Type t) throws ClassNotFoundException {
        ...
        /*
         * Yes, it's true: It's the same definition. See vmspec2 AASTORE / CHECKCAST
         * definitions.
         */
    }
}
