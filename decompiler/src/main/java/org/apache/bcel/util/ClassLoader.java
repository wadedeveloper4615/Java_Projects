...
public class ClassLoader extends java.lang.ClassLoader {
    ...
    /**
     * Ignored packages are by default ( "java.", "sun.", "javax."), i.e. loaded by
     * system class loader
     */
    public ClassLoader() {
    ...
    /**
     * Override this method to create you own classes on the fly. The name contains
     * the special token $$BCEL$$. Everything before that token is considered to be
     * a package name. You can encode your own arguments into the subsequent string.
     * You must ensure however not to use any "illegal" characters, i.e., characters
     * that may not appear in a Java class name too
     * <p>
     * The default implementation interprets the string as a encoded compressed Java
     * class, unpacks and decodes it with the Utility.decode() method, and parses
     * the resulting byte array and returns the resulting JavaClass object.
     * </p>
     *
    ...
    protected JavaClass createClass(final String class_name) {
        ...
        final ConstantClass cl = (ConstantClass) cp.getConstant(clazz.getClassName().getNameIndex(), Const.CONSTANT_Class);
    ...
    protected Class<?> loadClass(final String class_name, final boolean resolve) throws ClassNotFoundException {
        ...
        if ((cl = classes.get(class_name)) == null) {
            /*
             * Second try: Load system class using system class loader. You better don't
