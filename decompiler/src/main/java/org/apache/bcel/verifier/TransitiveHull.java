...
/**
 * This class has a main method implementing a demonstration program of how to
 * use the VerifierFactoryObserver. It transitively verifies all class files
 * encountered; this may take up a lot of time and, more notably, memory.
 *
 */
public class TransitiveHull implements VerifierFactoryObserver {
    ...
    /**
     * This method implements a demonstration program of how to use the
     * VerifierFactoryObserver. It transitively verifies all class files
     * encountered; this may take up a lot of time and, more notably, memory.
     */
