...
/**
 * A Verifier instance is there to verify a class file according to The Java
 * Virtual Machine Specification, 2nd Edition.
 *
 * Pass-3b-verification includes pass-3a-verification; pass-3a-verification
 * includes pass-2-verification; pass-2-verification includes
 * pass-1-verification.
 *
...
public class Verifier {
    ...
    /**
     * The Pass3aVerifiers for this Verifier instance. Key: Interned string
     * specifying the method number.
     */
    private final Map<String, Pass3aVerifier> p3avs = new HashMap<>();
    /**
     * The Pass3bVerifiers for this Verifier instance. Key: Interned string
     * specifying the method number.
     */
