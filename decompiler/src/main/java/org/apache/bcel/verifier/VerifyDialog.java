...
/**
 * A class for simple graphical class file verification. Use the main(String [])
 * method with fully qualified class names as arguments to use it as a
 * stand-alone application. Use the VerifyDialog(String) constructor to use this
 * class in your application. [This class was created using VisualAge for Java,
...
public class VerifyDialog extends javax.swing.JDialog {
    ...
    /**
     * The class to verify. Default set to 'java.lang.Object' in case this class is
     * instantiated via one of the many machine-generated constructors.
     */
    private String class_name = "java.lang.Object";
    /**
     * This field is here to count the number of open VerifyDialog instances so the
     * JVM can be exited afer every Dialog had been closed.
     */
    ...
    /**
     * Use this constructor if you want a possibility to verify other class files
    ...
    /**
     * Verifies one or more class files. Verification results are presented
     * graphically: Red means 'rejected', green means 'passed' while yellow means
