...
/**
 * Instances of this class should never be thrown. When such an instance is
 * thrown, this is due to an INTERNAL ERROR of BCEL's class file verifier
 * &quot;JustIce&quot;.
 *
 */
public final class AssertionViolatedException extends RuntimeException {
    ...
    /**
     * Constructs a new AssertionViolatedException with null as its error message
     * string.
     */
    ...
    /**
     * Constructs a new AssertionViolatedException with the specified error message
     * preceded by &quot;INTERNAL ERROR: &quot;.
     */
    ...
    /**
     * Constructs a new AssertionViolationException with the specified error message
     * and initial cause
     * 
     * @since 6.0
     */
     ...
     * 'old' error message. All of these three strings are allowed to be null, and
     * null is always replaced by the empty string (""). In particular, after
     * invoking this method, the error message of this object can no longer be null.
     */
