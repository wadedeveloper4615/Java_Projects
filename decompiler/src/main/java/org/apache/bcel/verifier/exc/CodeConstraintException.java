 ...
 * when a class file does not pass the verification pass 3. Note that the pass 3
 * used by "JustIce" involves verification that is usually delayed to pass 4.
 *
 */
public abstract class CodeConstraintException extends VerificationException {
    ...
    /**
     * Constructs a new CodeConstraintException with null as its error message
     * string.
     */
