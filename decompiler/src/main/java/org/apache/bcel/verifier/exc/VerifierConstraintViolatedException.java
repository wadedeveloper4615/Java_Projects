 ...
 * whenever verification proves that some constraint of a class file (as stated
 * in the Java Virtual Machine Specification, Edition 2) is violated. This is
...
public abstract class VerifierConstraintViolatedException extends RuntimeException {
    ...
    /**
     * Constructs a new VerifierConstraintViolatedException with null as its error
     * message string.
     */
    ...
    /**
     * Constructs a new VerifierConstraintViolationException with the specified
