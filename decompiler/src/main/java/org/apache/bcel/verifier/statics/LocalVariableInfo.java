...
/**
 * A utility class holding the information about the name and the type of a
 * local variable in a given slot (== index). This information often changes in
 * course of byte code offsets.
 */
public class LocalVariableInfo {
    ...
    /**
     * Adds a name of a local variable and a certain slot to our 'names' (Hashtable)
     * database.
     */
    ...
    /**
     * Adds a type of a local variable and a certain slot to our 'types' (Hashtable)
     * database.
     */
    ...
    /**
     * Returns the type of the local variable that uses this local variable slot at
     * the given bytecode offset. Care for legal bytecode offsets yourself,
     * otherwise the return value might be wrong. May return 'null' if nothing is
     * known about the type of this local variable slot at the given bytecode
     * offset.
     *
     * @param offset bytecode offset.
     * @return the type of the local variable that uses this local variable slot at
    ...
    /**
     * Returns the name of the local variable that uses this local variable slot at
     * the given bytecode offset. Care for legal bytecode offsets yourself,
     * otherwise the return value might be wrong. May return 'null' if nothing is
     * known about the type of this local variable slot at the given bytecode
     * offset.
     *
     * @param offset bytecode offset.
     * @return the name of the local variable that uses this local variable slot at
     *         the given bytecode offset.
     */
