...
/**
 * A utility class holding the information about the names and the types of the
 * local variables in a given method.
 */
public class LocalVariablesInfo {
    ...
    /**
     * Adds information about the local variable in slot 'slot'. Automatically adds
     * information for slot+1 if 't' is Type.LONG or Type.DOUBLE.
     *
