...
/**
 * This PassVerifier verifies a class file according to pass 3, static part as
 * described in The Java Virtual Machine Specification, 2nd edition. More
 * detailed information is to be found at the do_verify() method's
 * documentation.
 *
 * @see #do_verify()
 */
public final class Pass3aVerifier extends PassVerifier {
    ...
    /**
     * This visitor class does the actual checking for the instruction operand's
     * constraints.
     */
    private class InstOperandConstraintVisitor extends org.apache.bcel.generic.EmptyVisitor {
        ...
        /**
         * Utility method to return the max_locals value of the method verified by the
         * surrounding Pass3aVerifier instance.
         */
        ...
        /**
         * A utility method to raise an exception if the index is not a valid constant
         * pool index.
         */
...
//                Type o_type = o.getType(cpg);
        ...
        /**
         * Looks for the method referenced by the given invoke instruction in the given
         * class or its super classes and super interfaces.
         * 
        ...
        /**
         * A utility method like equals(Object) for arrays. The equality of the elements
         * is based on their equals(Object) method instead of their object identity.
         */
