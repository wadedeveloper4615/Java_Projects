...
public class ControlFlowGraph {
    ...
    /**
     * Objects of this class represent a node in a ControlFlowGraph. These nodes are
    ...
    private class InstructionContextImpl implements InstructionContext {
        ...
        /**
         * The 'execution predecessors' - a list of type InstructionContext of those
         * instances that have been execute()d before in that order.
         */
        private List<InstructionContext> executionPredecessors = null; // Type: InstructionContext

        /**
         * Creates an InstructionHandleImpl object from an InstructionHandle. Creation
         * of one per InstructionHandle suffices. Don't create more.
         */
        ...
        /**
         * Returns a clone of the "outgoing" frame situation with respect to the given
         * ExecutionChain.
         */
        @Override
        ...
        /**
         * "Merges in" (vmspec2, page 146) the "incoming" frame situation; executes the
         * instructions symbolically and therefore calculates the "outgoing" frame
         * situation. Returns: True iff the "incoming" frame situation changed after
         * merging with "inFrame". The execPreds ArrayList must contain the
         * InstructionContext objects executed so far in the correct order. This is just
         * one execution path [out of many]. This is needed to correctly "merge" in the
         * special case of a RET's successor. <B>The InstConstraintVisitor and
         * ExecutionVisitor instances must be set up correctly.</B>
         * 
         * @return true - if and only if the "outgoing" frame situation changed from the
         *         one before execute()ing.
         */
        @Override
...
//ExecutionVisitor ev = ExecutionVisitor.getInstance(VerifierFactory.getVerifier(method_gen.getClassName()));
        ...
        /**
         * Does the actual merging (vmspec2, page 146). Returns true IFF this.inFrame
         * was changed in course of merging with inFrame.
         */
        ...
        /**
         * Returns the control flow execution chain. This is built while execute(Frame,
         * ArrayList)-ing the code represented by the surrounding ControlFlowGraph.
         */
         ...
         * at-the-end-extended message. This extended message will then reflect the
         * execution flow needed to get to the constraint violation that triggered the
         * throwing of the "e" object.
         */
        ...
        /**
         * Returns the InstructionContextImpl with an JSR/JSR_W that was last in the
         * ExecutionChain, without a corresponding RET, i.e. we were called by this one.
         ...
         * That means, a RET does have successors as defined here. A JsrInstruction has
         * its target as its successor (opposed to its physical successor) as defined
         * here.
         */
...
//throw new AssertionViolatedException("DID YOU REALLY WANT TO ASK FOR RET'S SUCCS?");
    ...
    /**
     * The Subroutines object for the method whose control flow is represented by
     * this ControlFlowGraph.
     */
    private final Subroutines subroutines;

    /**
     * The ExceptionHandlers object for the method whose control flow is represented
    ...
    /**
     * Returns an InstructionContext[] with all the InstructionContext instances for
     * the method whose control flow is represented by this ControlFlowGraph <B>(NOT
     * ORDERED!)</B>.
     */
