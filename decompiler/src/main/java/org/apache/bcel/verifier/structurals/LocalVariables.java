...
public class LocalVariables implements Cloneable {
    ...
    /**
     * Returns a deep copy of this object; i.e. the clone operates on a new local
     * variable array. However, the Type objects in the array are shared.
     */
    @Override
    public Object clone() {
    ...
    /**
     * Merges two local variables sets as described in the Java Virtual Machine
     * Specification, Second Edition, section 4.9.2, page 146.
     *
        ...
        try {
            ...
            if ((locals[i] instanceof ReferenceType) && (lv.locals[i] instanceof ReferenceType)) {
                ...
                if (!(locals[i].equals(lv.locals[i]))) {
                    /*
                     * TODO if ((locals[i] instanceof org.apache.bcel.generic.ReturnaddressType) &&
                     * (lv.locals[i] instanceof org.apache.bcel.generic.ReturnaddressType)) {
                     * //System.err.println("merging "+locals[i]+" and "+lv.locals[i]); throw new
                     * AssertionViolatedException("Merging different ReturnAddresses: '"+locals[i]
                     * +"' and '"+lv.locals[i]+"'."); }
                     */
                    locals[i] = Type.UNKNOWN;
                }
    ...
    /**
     * Replaces all occurrences of {@code uninitializedObjectType} in this local
     * variables set with an "initialized" ObjectType.
     *
