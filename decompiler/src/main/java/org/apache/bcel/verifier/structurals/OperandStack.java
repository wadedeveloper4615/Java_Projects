...
/**
 * This class implements a stack used for symbolic JVM stack simulation. [It's
 * used an an operand stack substitute.] Elements of this stack are {@link Type}
 * objects.
 *
 */
public class OperandStack implements Cloneable {
    ...
    /**
     * Creates an otherwise empty stack with a maximum of maxStack slots and the
     * ObjectType 'obj' at the top.
     */
    ...
    /**
     * Returns a deep copy of this object; that means, the clone operates on a new
     * stack. However, the Type objects on the stack are shared.
     */
    @Override
    public Object clone() {
    ...
    /**
     * Returns true if and only if this OperandStack equals another, meaning equal
     * lengths and equal objects on the stacks.
     */
    @Override
    ...
    /**
     * Returns the element on top of the stack. The element is not popped off the
     * stack!
     */
    public Type peek() {
        return peek(0);
    ...
    /**
     * Returns the element that's i elements below the top element; that means, iff
     * i==0 the top element is returned. The element is not popped off the stack!
     */
    ...
    /**
     * Returns the size of this OperandStack; that means, how many Type objects
     * there are.
     */
    public int size() {
        return stack.size();
    ...
    public int slotsUsed() {
        /*
         * XXX change this to a better implementation using a variable that keeps track
         * of the actual slotsUsed()-value monitoring all push()es and pop()s.
         */
        int slots = 0;
    ...
    /**
     * Merges another stack state into this instance's stack state. See the Java
     * Virtual Machine Specification, Second Edition, page 146: 4.9.2 for details.
     */
    ...
    /**
     * Replaces all occurences of u in this OperandStack instance with an
