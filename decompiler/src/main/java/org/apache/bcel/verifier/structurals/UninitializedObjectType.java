...
/**
 * This class represents an uninitialized object type; see The Java Virtual
 * Machine Specification, Second Edition, page 147: 4.9.4 for more details.
 *
 */
public class UninitializedObjectType extends ReferenceType implements Constants {
    ...
    /**
     * Returns the ObjectType of the same class as the one of the uninitialized
     * object represented by this UninitializedObjectType instance.
     */
     ...
     * instances of "initialized" equal one another in this and the o instance.
     *
     */
    @Override
