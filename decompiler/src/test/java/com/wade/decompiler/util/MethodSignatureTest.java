...
class MethodSignatureTest {
    ...
    void testMethodSignatureArrayPrimitives() {
        ...
        assertEquals(TypeEnum.T_INT, ms.getReturnType().getBaseType());
        ...
        assertEquals(TypeEnum.T_INT, ms.getParameterTypes()[4].getIndexType());
    ...
    void testMethodSignaturePrimitives() {
        ...
        assertEquals(TypeEnum.T_INT, ms.getParameterTypes()[4].getBaseType());
    ...
    void testMethodSignatureReferences() {
        ...
        assertEquals(TypeEnum.T_INT, ms.getParameterTypes()[0].getBaseType());
